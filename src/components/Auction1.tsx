                ...
                {auction.product?.url ? (
                    <div className="bg-white shadow-lg rounded-lg overflow-hidden w-auto h-auto md:h-[550px] lg:h-[465px] md:w-[400px] transition-transform duration-200 hover:-translate-y-1 mb-8">
                        ...
                        <div className="p-4 lg:p-6">
                            ...
                            <button className="mt-2 lg:mt-1 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 lg:py-3 px-4 lg:px-6 rounded-full transition duration-300">Start Bid</button>
                        </div>
                    </div>
                ) : null}
            </Link>
