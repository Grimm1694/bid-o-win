        ...
        <div className="mt-[1250px]">
            <div style={styles.navbar}>
                <div style={styles.navbarLeft}>
                    <img
                        src="https://cdn.prod.website-files.com/5bc3ba13ca643a62b72ee828/6583b9bf48512591a8b281cc_GalaBid_Inverted_Website.svg"
                        alt="Logo"
                        style={styles.navbarImage}
                    />
                    <a href="#home" style={styles.navbarLink}>Home</a>
                    <a href="#about" style={styles.navbarLink}>About</a>
                    <a href="#services" style={styles.navbarLink}>Services</a>
                    <a href="#contact" style={styles.navbarLink}>Contact</a>
                </div>
